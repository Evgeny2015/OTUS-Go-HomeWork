...
//
// CalendarService provides operations for calendar events
...
func (c *calendarServiceClient) ListEventsForDay(ctx context.Context, in *ListEventsForDayRequest, opts ...grpc.CallOption) (*ListEventsForDayResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *calendarServiceClient) ListEventsForWeek(ctx context.Context, in *ListEventsForWeekRequest, opts ...grpc.CallOption) (*ListEventsForWeekResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *calendarServiceClient) ListEventsForMonth(ctx context.Context, in *ListEventsForMonthRequest, opts ...grpc.CallOption) (*ListEventsForMonthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCalendarServiceServer) ListEventsForDay(context.Context, *ListEventsForDayRequest) (*ListEventsForDayResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEventsForDay not implemented")
}
func (UnimplementedCalendarServiceServer) ListEventsForWeek(context.Context, *ListEventsForWeekRequest) (*ListEventsForWeekResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEventsForWeek not implemented")
}
func (UnimplementedCalendarServiceServer) ListEventsForMonth(context.Context, *ListEventsForMonthRequest) (*ListEventsForMonthResponse, error) {
...
var CalendarService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/protobuf/calendar_service.proto",
}
